...
import { CollegeModal } from "../components";

const MIN_HEIGHT = Platform.OS === "ios" ? 90 : 120;
const MAX_HEIGHT = 350;

const ScrollViewComp = ({ route, departmentData }) => {
  ...
  return (
    <View style={styles.container}>
      <ImageHeaderScrollView
        ...
        renderHeader={() => (
          <Image
            source={require("../assets/Cover/books.jpg")}
            style={styles.image}
          />
        )}
        renderFixedForeground={() => (
          ...
          >
            ...
            <Animatable.View style={styles.navTitleView} ref={navTitleView}>
              {showTitle && <Text style={styles.navTitle}>Explore Books</Text>}
            </Animatable.View>
          </View>
        )}
      >
        <View style={{ height: 1000 }}>
          ...
          >
            <CollegeModal departmentData={departmentData} />
          </TriggeringView>
        </View>
      </ImageHeaderScrollView>
    </View>
