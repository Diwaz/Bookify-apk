import { View, Text, SafeAreaView,StyleSheet,TouchableOpacity,TouchableWithoutFeedback,Dimensions,TextInput,Button} from 'react-native';
...
<View style={style.header}>
    ...
    <DrawerC/>
    <Logo/>
    <TouchableOpacity style={{flex:1,display:'flex',alignItems:'center'}}
     onPress={
      onFocus
      }
      >
        ...
        <Ionicons name='search-outline' style={style.search} size={24} color={'#1C2363'} />
        </Text>
    </TouchableOpacity>
    ...
    { focused &&<View style={style.animatingLayer}> 
    ...
    <Ionicons name='chevron-back-outline'  size={24} color={'#1C2363'} />
    </TouchableOpacity>
            </View>
            <View style={style.Inputbar}>
              ...
              style={[Platform.OS === "web" && {outlineStyle: 'none' },style.inputbox]}
